        ...
        <div class="picture">
            ...
            <div class="text3">
                ...
                <div class="box2">
                    ...
                    {{-- <div class="tashi"> <a href="{{ route('add-cart') }}"><i class="bi bi-cart-check-fill"></i></a>
                    </div> --}}
                    {{-- <div class="tashi"> <a href="{{ route('cart.store',['cart' => $item->id]) }}"><i
                                class="bi bi-cart-check-fill"></i></a></div> --}}
                    {{-- <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#viewBanner{{ $item->id }}"><i class="bi bi-cart-check-fill"></i></button> --}}
